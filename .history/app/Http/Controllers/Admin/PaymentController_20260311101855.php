...

{
     ...
     * Atualizado: Filtra reservas rejeitadas/canceladas e mantém integridade do saldo.
     */
    public function index(Request $request)
    {
        ...
        $query = Reserva::with(['user', 'arena', 'transactions'])
            ->whereNotIn('status', ['rejected', 'cancelled']); // 🚫 Nunca mostrar rejeitadas ou canceladas
