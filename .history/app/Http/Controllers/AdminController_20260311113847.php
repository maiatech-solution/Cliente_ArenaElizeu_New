    ...
    public function moverManutencao(Request $request, $id)
    {
        ...
        return DB::transaction(function () use ($request, $id) {
            try {
                ...
                // 4. Cálculo do valor real em caixa (Somente entradas positivas vinculadas)
                ...
                if ($saldoLiquido > 0 && ($action === 'transfer' || $action === 'credit')) {
                    ...
                    if ($proxima) {
                        // ✨ CORREÇÃO CRÍTICA DE DATA: Limpa a data da reserva para Y-m-d antes de juntar com a hora
