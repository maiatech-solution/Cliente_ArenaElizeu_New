    ...
    public function moverManutencao(Request $request, $id)
    {
        ...
        return DB::transaction(function () use ($request, $id) {
            try {
                ...
                // 💰 SALDO LÍQUIDO: Soma real do que está vinculado a ESTA reserva especificamente
                ...
                if ($saldoLiquido > 0 && ($action === 'transfer' || $action === 'credit')) {
                    ...
                    if ($proxima) {
                        ...
                        // Só altera transações que AINDA estão apontando para a reserva de origem
                        ...
                        // ✨ PASSO B: Recálculo Real no Destino
                        // O valor da reserva de destino é definido EXCLUSIVAMENTE pelo que está no extrato dela agora
                ...
                // 6. Estorno com Trava de Segurança
                ...
                // 7. Finalização: Limpeza da Reserva de Origem
                $backup = [
                    'name' => $nomeLimpo,
                    'contact' => $contato,
                    'user_id' => $userId,
                ...
                return response()->json(['success' => true, 'message' => 'Manutenção aplicada com sucesso.']);
            } catch (\Exception $e) {
