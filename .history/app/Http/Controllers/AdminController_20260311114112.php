    ...
    public function moverManutencao(Request $request, $id)
    {
        ...
        return DB::transaction(function () use ($request, $id) {
            try {
                ...
                // 💰 SALDO ATUAL: Soma real do que está nesta reserva agora
                ...
                if ($saldoLiquido > 0 && ($action === 'transfer' || $action === 'credit')) {
                    ...
                    if ($proxima) {
                        ...
                        // ✨ PASSO B: RECALCULO ABSOLUTO (O "Anti-Gambi")
                        // Não somamos ao valor antigo. Resetamos e somamos o extrato novo da reserva destino.
                        ...
                        $proxima->update([
                            ...
                            'status'         => 'confirmed',
                            'client_name'    => $nomeLimpo // Garante que o nome volta ao normal na próxima
                        ]);
                ...
                // 6. ESTORNO (Com trava de integridade)
