    ...
    public function indexFinancialDashboard(Request $request)
    {
        ...
        $reservasQuery = Reserva::where('is_fixed', false)
            ...
            ->map(function ($reserva) use ($date) {
                // ✨ A CORREÇÃO CRÍTICA:
                // O "Total Pago" exibido no caixa AGORA é calculado em tempo real pelo extrato do dia.
                // Se o dinheiro foi transferido para outra data, o sum() abaixo retorna 0 para hoje.
        ...
        // 3.1 Total Real em Caixa (Dinheiro que de fato entrou hoje)
        ...
        // 3.2 Receita Total Exibida (Jogos + Multas)
        ...
        // 3.4 Pendências (Somente de quem ainda consta como ativo hoje)
        ...
        return view('admin.financial.index', [
            ...
            'totalExpected' => $totalExpected + $receitaMultas,
