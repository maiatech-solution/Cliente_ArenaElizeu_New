            ...
            */
                ...
                if ($decisao === 'restore_client') {
                    ...
                    */
                        ...
                        /*
                    |--------------------------------------------------------------------------
                    | SINCRONIZAÇÃO FINANCEIRA SEGURA
                    |--------------------------------------------------------------------------
                    */

                        if ($acaoRealizada === 'refund') {

                            // Verifica se já existe estorno automático
                            $jaExisteEstornoAuto = DB::table('financial_transactions')
                                ->where('reserva_id', $reserva->id)
                                ->where('description', 'like', 'ESTORNO AUTOMÁTICO (Reativação manutenção%')
                                ->exists();

                            if (!$jaExisteEstornoAuto) {
