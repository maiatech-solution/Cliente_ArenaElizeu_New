...
class BarReportController extends Controller
{
    ...
    public function daily(Request $request)
    {
        ...
        // 🎯 BUSCA DIRETO NAS VENDAS (A verdade da operação: 19 unidades)
        ...
        foreach ($orderItems as $i) {
            ...
            $venda = $i->subtotal;
            $lucro = $venda - (($i->product->purchase_price ?? 0) * $i->quantity);
            $datas[$dia]['mesas'] += $venda;
            $datas[$dia]['lucro_mesas'] += $lucro;
        }
