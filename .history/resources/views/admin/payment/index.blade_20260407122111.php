        ...
        if (!window.__CAIXA_SCRIPT_LOADED) {
            ...
            function setupAjaxForm(formId, btnId, spinnerId, errorId, urlTemplate) {
                ...
                form.onsubmit = function(e) {
                    ...
                    // ✨ AJUSTE AQUI: Removido 'openCashForm' e 'closeCashForm' desta lista
                    const acoesCriticas = ['debtForm', 'noShowForm', 'transactionForm', 'paymentForm'];
                    ...
                    if (acoesCriticas.includes(formId) && userRole === 'colaborador') {
                        ...
                        // Se o formId for 'openCashForm' ou 'closeCashForm', ele cairá direto aqui
                        enviarParaOServidor();
                    }
