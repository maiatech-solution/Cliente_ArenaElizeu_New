<x-app-layout>
   ...
   <script>
    (function() {
        ...
        window.openCancellationModal = function(reservaId, method, urlBase, message, buttonText, totalPaid = 0, isRecurrent = false) {
        ...
        window.openNoShowModal = function(reservaId, clientName, totalPaid) {
            ...
            if (currentTotalPaid > 0) {
                ...
                document.getElementById('no-show-paid-amount-display').textContent = currentTotalPaid.toLocaleString('pt-BR', { minimumFractionDigits: 2 });
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (confirmCancelBtn) {
                confirmCancelBtn.addEventListener('click', function() {
                    ...
                    executeAjax(url.replace(':id', currentReservaId), method, {
                        ...
                        should_refund: document.getElementById('should_refund')?.checked ? 1 : 0,
            ...
            if (confirmNoShowBtn) {
                confirmNoShowBtn.addEventListener('click', function() {
                    ...
                    if (shouldRefund && refundAmount > currentTotalPaid) return alert("Valor de estorno inválido.");
