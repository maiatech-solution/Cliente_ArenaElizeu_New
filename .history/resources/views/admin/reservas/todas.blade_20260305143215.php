    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-2xl sm:rounded-xl p-6 lg:p-10">
                ...
                {{-- INSIRA ESTE BLOCO LOGO ABAIXO --}}
                <div class="mb-6 flex items-center bg-purple-50 px-4 py-2 rounded-xl border border-purple-100 w-fit">
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" id="toggle_mine" class="sr-only peer" {{ $isOnlyMine ? 'checked' : '' }}
                            onchange="window.location.href='{{ route('admin.reservas.todas', array_merge(request()->query(), ['only_mine' => $isOnlyMine ? 'false' : 'true'])) }}'">
                        <div
                            class="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-purple-600">
                        </div>
                        <span class="ml-3 text-xs font-black text-purple-700 uppercase tracking-tighter">Minhas
                            Ações</span>
                    </label>
                </div>
