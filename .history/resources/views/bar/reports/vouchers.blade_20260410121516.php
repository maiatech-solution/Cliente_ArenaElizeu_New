                            ...
                            <tr class="hover:bg-white/[0.02] transition-colors group">
                                ...
                                <td class="p-6">
                                    <div class="flex flex-col leading-none gap-1">
                                        <span class="text-white font-black uppercase italic text-sm italic">{{ $item->customer_name ?? 'Consumidor' }}</span>
                                ...
                                <td class="p-6 text-center">
                                    @php
                                        // Decide o tipo e ID para a função JS baseada na origem
                                        $tipoJS = $item->bar_order_id ? 'mesa' : 'pdv';
                                        $idJS = $item->bar_order_id ?? $item->bar_sale_id;
                                    @endphp
                                    <button @click="openVendaDetails('{{ $tipoJS }}', {{ $idJS ?? $item->id }})"
