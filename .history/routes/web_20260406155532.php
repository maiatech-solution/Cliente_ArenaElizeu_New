...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::middleware(['role:admin,gestor'])->group(function () {
            ...
            // 🚀 CORREÇÃO: Rotas de exclusão agora aceitam ID e usam o método DELETE
            Route::delete('/config/delete-slot-config/{id}', [ConfigurationController::class, 'deleteSlotConfig'])->name('config.delete_slot_config');
            Route::delete('/config/delete-day-config/{id}', [ConfigurationController::class, 'deleteDayConfig'])->name('config.delete_day_config');
        });
