...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::middleware(['role:admin,gestor'])->group(function () {
            ...
            // 🚀 AJUSTE AQUI: Adicionado /{id} e /{dayOfWeek} para casar com a chamada do seu JS
            Route::post('/config/delete-slot-config/{id}', [ConfigurationController::class, 'deleteSlotConfig'])->name('config.delete_slot_config');
            Route::post('/config/delete-day-config/{dayOfWeek}', [ConfigurationController::class, 'deleteDayConfig'])->name('config.delete_day_config');
        });
