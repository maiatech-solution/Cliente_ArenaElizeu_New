                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="text-gray-400 text-[10px] font-black uppercase tracking-widest border-b dark:border-gray-700 bg-gray-50/50 dark:bg-black/20">
                            ...
                            <th class="p-6 text-right text-amber-500">Cortesias (Vouchers)</th>
                    ...
                    <tbody class="divide-y dark:divide-gray-700">
                        @forelse($operadores as $rank)
                            <tr class="hover:bg-indigo-50/30 dark:hover:bg-white/[0.02] transition-colors group">
                                ...
                                <td class="p-6 text-right text-gray-400 font-mono text-xs font-bold">
                                ...
                                {{-- 🎁 COLUNA DE CORTESIAS --}}
                                <td class="p-6 text-right text-amber-600/70 font-mono text-xs italic">
                                    - R$ {{ number_format($rank->total_vouchers, 2, ',', '.') }}
                                </td>
